...
window.onload = () => {
    ...
    bp.ContactEmployees = new Array<SAPB1.ContactEmployee>(2);
    ...
    so.DocumentLines = new Array<SAPB1.DocumentLine>();
    ...
    newCampaign.CampaignBusinessPartners = new Array<SAPB1.CampaignBusinessPartner>();
    ...
    newCampaign.CampaignItems = new Array<SAPB1.CampaignItem>();
